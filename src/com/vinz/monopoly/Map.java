...
public class Map {
    ...
    public ArrayList<Land> getAllGroupLands(Group group) {

        ArrayList<Land> groupLands = new ArrayList<>();

        for (Land currentland : getAllLands()) {

            if (currentland.getGroup() == group) {
                groupLands.add(currentland);
            }
        }
